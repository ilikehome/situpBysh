...
while True:
    ...
    print(f"Time taken for prediction: {elapsed_prediction_time} seconds")

    center_x, center_y = get_pic_center_xy()
    # 绘制关键点
    ...
    end_time = time.time()
    elapsed_time = end_time - start_prediction_time
    print(f"Time taken for all: {elapsed_time} seconds")
# 释放资源
cap.release()
